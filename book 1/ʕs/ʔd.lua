...
• Added a "Hide machine ESP if completed" toggle. (Boxten's Section/Environment/ESPs)
...
• Added a "Orbit target player" toggle. (Boxten's Section/Fun/Actions)
• Added a "Orbit target" input. (Boxten's Section/Fun/Actions)
...
• Added a "Prioritize health" toggle. (Boxten's Section/Automation/Autofarm settings)
• Added a "Prioritize extraction speed" toggle. (Boxten's Section/Automation/Autofarm settings)
• Added a "Prioritize Research" toggle. (Boxten's Section/Automation/Autofarm settings)
...
• Added a "Access" section. (Boxten's Section/Donor) (+6 Functions)
• Added a "Actions" section. (Boxten's Section/Donor) (+9 Functions)
