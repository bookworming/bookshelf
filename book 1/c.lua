...
"xhantist","penqulum","heartcloak","bcxten","O0OO00O000O","inconspicuosity","IlIlIllllIlIll_1","ichorichorichorichor"
},
hypnic={
...
"blotxboxten","boxtengexsui","lesbianbobette","lesbianteagan","cosmoxshelly","bcxten","O0OO00O000O","inconspicuosity","IlIlIllllIlIll_1","ichorichorichorichor"
},
blacklisted={
...
local up=box.hrp.CFrame.UpVector
local newPos=box.hrp.Position+(right*X)+(up*Y)+(forward*Z)
return newPos
end
return Vector3.zero
end
...
einpt(nil,box["local player holder"],"Offset Twisteds Input","Inputs the X and Z values of the offset.","X, Y, Z (Numbers)",function(xzinput)
...
loadstring(game:HttpGet"https://raw.githubusercontent.com/ineptpractices/b-xten-s-x-gui/refs/heads/main/temporary/vb.lua")()
end)
